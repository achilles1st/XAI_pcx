...
data_base_path = '/mnt/neuro/nas2/Work/Graz_plus_R2star/04_concepts/01_heatmaps/deep_taylor_decomposition/relevance/ref_images/R2star_RG/Both_warped_class_mean'

for class_name, z_plus_file  in [
  ('CN_AD_mean_diff', '/mnt/neuro/nas2/Work/Graz_plus_R2star/03_results/02_performance/heatmaps_warped/R2star_RG/boostrap_index-05__initial_weights_index-02'),
  ('CN_mean', '/mnt/neuro/nas2/Work/Graz_plus_R2star/03_results/02_performance/heatmaps_warped/R2star_RG/boostrap_index-05__initial_weights_index-02'),
  ('AD_mean', '/mnt/neuro/nas2/Work/Graz_plus_R2star/03_results/02_performance/heatmaps_warped/R2star_RG/boostrap_index-05__initial_weights_index-02'),
]:
  target_base_path = os.path.join(this_file_path, class_name)
  ...
  mean_concepts.insert(0, f'{z_plus_file}/{class_name}.nii.gz')
  ...
  for mean_concept in mean_concepts:
    if count_conecpts > 0 and not mean_concept.endswith(f'_{class_name}.nii.gz'):
      continue
