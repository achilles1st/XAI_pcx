...
config_dir = "configs/cifar10_configs"
...
def store_local(config, config_name):
    ...
    config['data_path'] = local_config['cifar10_dir']
    ...
    for layer_name in [layer_name]:
        ...
        for lr in [
            ...
            for pretrained in [True,]:
                ...
                config_name = f"{model_name}_cifar10_pretrained_{pretrained}_{method}_{optim_name}_lr{lr}_{layer_name}"
